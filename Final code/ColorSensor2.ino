...
unsigned char colorSensor(char color)
{
  unsigned int counter = 0; //gets input from sensor frequency generator
  unsigned int countR = 0; //accumilates reading over 8 times to get average
  unsigned char count = 0; //saves the final average reading
